...
(function (e) {
    ...
    h.prototype.showDrillUpButton = function () {
        ...
        this.drillUpButton ? this.drillUpButton.attr({
            text: a
        }).align() : this.drillUpButton = this.renderer.button(a, null, null, function () {
            b.drillUp()
        }).attr(n({
    ...
    o(e.Series.prototype, "drawDataLabels", function (b) {
        ...
        g(this.points, function (b) {
            if (b.drilldown && b.dataLabel) b.dataLabel.attr({
