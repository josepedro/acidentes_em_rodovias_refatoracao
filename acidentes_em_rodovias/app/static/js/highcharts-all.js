...
var HighchartsAdapter = function () {
    function o(c) {
        ...
        function b(b, c) {
            ...
            for (j in g)
                if (f[j])
                    for (k = f[j].length; k--;) i(b, j, f[j][k])
        }
...
(function (l, C) {
        ...
        T = {
            ...
            getPlotBandPath: function (a, b, c) {
                ...
                this.options.gridLineInterpolation === "polygon" ? d = this.getPlotLinePath(a).concat(this.getPlotLinePath(b, !0)) : (k || (e[0] = this.translate(a), e[1] = this.translate(b)), e = R(e, function (a) {
                    ...
                    "circle" || !k ? (a = -Math.PI / 2, b = Math.PI * 1.5, o = !0) : (a = g + this.translate(a), b = g + this.translate(b)), d = this.chart.renderer.symbols.arc(this.left + d[0], this.top + d[1], e[0], e[0], {
                        start: a,
                        end: b,
    ...
    n(u, "getLabelPosition", function (a, b, c, d, g, f, e, i, o) {
        ...
        k.isRadial ? (a = k.getPosition(this.pos, k.center[2] / 2 + q(f.distance, -25)), f.rotation === "auto" ? d.attr({
                rotation: l
            }) : j === null && (j = v(d.styles.lineHeight) * 0.9 - d.getBBox().height / 2), h === null &&
            (h = k.isCircular ? l > 20 && l < 160 ? "left" : l > 200 && l < 340 ? "right" : "center" : "center", d.attr({
                align: h
            })), a.x += f.x, a.y += j) : a = a.call(this, b, c, d, g, f, e, i, o);
        return a
    });
    ...
    m.columnrange = p(m.column, m.arearange, {
        lineWidth: 1,
        pointRange: null
    });
        ...
        drawPoints: function () {
            ...
            r(a.points, function (c) {
                var b = c.graphic,
                    ...
                    k = g.d,
                    j = p(d.dial, c.dial);
                b ? (b.animate(g), g.d = k) : c.graphic = f[c.shapeType](g).attr({
            ...
            c ? c.animate({
                translateX: b[0],
                translateY: b[1]
            }) : a.pivot = f.circle(0, 0, q(g.radius, 5)).attr({
    ...
    h.boxplot = x(h.column, {
        ...
        drawPoints: function () {
            var a = this,
                ...
                c = a.options,
                d = a.chart.renderer,
                g, f, e, i, o, k, j, h, l, m, n, H, p, E, I, t, w, s, v, u, z, y, x = a.doQuartiles !== !1,
    ...
    m.errorbar = p(m.boxplot, {
        ...
        linkedTo: ":previous",
        tooltip: {
            pointFormat: m.arearange.tooltip.pointFormat
        },
        whiskerWidth: null
    });
    ...
    h.bubble = x(h.scatter, {
        ...
        translate: function () {
            ...
            for (a = b.length; a--;) c =
                b[a], d = g ? g[a] : 0, c.negative = c.z < (this.options.zThreshold || 0), d >= this.minPxSize / 2 ? (c.shapeType = "circle", c.shapeArgs = {
                    x: c.plotX,
                    y: c.plotY,
                    r: d
                }, c.dlBox = {
    ...
    N.prototype.beforePadding = function () {
        var a = this,
            ...
            e = f ? "xData" : "yData",
            i = this.min,
            h = {}, k = s.min(c.plotWidth, c.plotHeight),
            j = Number.MAX_VALUE,
            l = -Number.MAX_VALUE,
            m = this.max - i,
            n = b / m,
        ...
        this.tickPositions && (r(this.series, function (b) {
            ...
            if (m > 0)
                for (; c--;) b[c] !== null && (k = a.radii[c], d = Math.min((b[c] - i) * n - k, d), g = Math.max((b[c] - i) * n + k, g))
    ...
    h.extend(m.prototype, {
        ...
        parseTypes: function () {
            for (var b = this.columns, a = b.length, c, d, f, i; a--;)
                for (c = b[a].length; c--;) d = b[a][c], f = parseFloat(d), i = this.trim(d),
